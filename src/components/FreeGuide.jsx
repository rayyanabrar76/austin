...
export default function FreeGuide() {
  ...
  return (
    <section id="guide" className="relative overflow-hidden border-b-2 border-ink bg-paper">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-2">
        {/* ---- Left: copy in a dark block ---- */}
        <div>
          <Reveal>
        ...
        {/* ---- Right: two-book cluster + FREE sticker ---- */}
        <Reveal className="relative flex min-h-[440px] items-center justify-center">
          {/* back book (peeking, rotated) */}
          <div className="absolute left-1/2 hidden -translate-x-[92%] rotate-[10deg] scale-90 opacity-95 sm:block">
            <Book3D variant="back" float={false} />
          </div>
          {/* front book */}
          <div className="relative z-10 sm:translate-x-8">
